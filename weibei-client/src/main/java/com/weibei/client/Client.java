...
import com.weibei.client.enums.Command;
import com.weibei.client.enums.Message;
import com.weibei.client.enums.RPCErr;
import com.weibei.client.pubsub.Publisher;
...
import com.weibei.client.subscriptions.TransactionSubscriptionManager;
...
import com.weibei.client.types.AccountLine;
...
import static com.weibei.client.requests.Request.Manager;
...
public class Client extends Publisher<Client.events> implements TransportEventHandler {
     ...
     *
     * Essentially, all weibei-lib-java api interaction
