...
import com.weibei.core.binary.STWriter;
import com.weibei.core.coretypes.*;
import com.weibei.core.coretypes.hash.Hash256;
import com.weibei.core.coretypes.hash.Index;
import com.weibei.core.coretypes.uint.UInt16;
import com.weibei.core.coretypes.uint.UInt32;
import com.weibei.core.coretypes.uint.UInt64;
import com.weibei.core.coretypes.uint.UInt8;
import com.weibei.core.fields.Field;
import com.weibei.core.formats.TxFormat;
...
import com.weibei.core.serialized.enums.LedgerEntryType;
import com.weibei.core.types.known.sle.LedgerEntry;
import com.weibei.core.types.known.sle.entries.AccountRoot;
import com.weibei.core.types.known.sle.entries.DirectoryNode;
import com.weibei.core.types.known.sle.entries.Offer;
import com.weibei.core.types.known.tx.result.TransactionMeta;
import com.weibei.core.types.known.tx.txns.Payment;
import com.weibei.core.types.shamap.AccountState;
...
//        File f = new File("/home/nick/dumps/ledger-full-120000.json");
    ...
    public void binaryParsingSerializingSanityTest() throws FileNotFoundException {
        ...
        File f = new File("weibei-core/src/test/java/com/weibei/resources/ledgers-full.json");
        if (!f.exists()) {
            return;
        }
    ...
    public void testNestedObjectSerialization() throws Exception {
        String weibeiLibHex = "120007220000000024000195F964400000170A53AC2065D5460561EC9DE000000000000000000000000000" +
        ...
        String weibeidHex = "";
        ...
        String weibeidMetaHex = "";
        String actual = tx.toHex();

        assertEquals(weibeidHex, weibeiLibHex);
        assertEquals(weibeidHex, actual);
        assertEquals(weibeidMetaHex.length(), meta.toHex().length());
        assertEquals(weibeidMetaHex, meta.toHex());
    }
    ...
    public void testNestedObjectSerialization2() throws Exception {
        ...
        String weibeidMetaHex = "";
        String weibeidHex = "";
    ...
    public void testParsingVector256() throws Exception {
        // This was a test case for a bug found in weibei-lib js
