package com.weibei.crypto.sjcljson;
...
import org.weibei.bouncycastle.crypto.engines.AESFastEngine;
import org.weibei.bouncycastle.crypto.generators.PKCS5S2ParametersGenerator;
import org.weibei.bouncycastle.crypto.modes.CCMBlockCipher;
import org.weibei.bouncycastle.crypto.params.AEADParameters;
import org.weibei.bouncycastle.crypto.params.KeyParameter;
import org.weibei.bouncycastle.util.encoders.Base64;
...
public class JSONEncrypt {
     ...
     *  https://github.com/AurionFinancial/AndroidWallet/blob/master/src/com/weibei/Blobvault.java
     *
