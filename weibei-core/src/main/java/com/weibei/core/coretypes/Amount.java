...
import com.weibei.core.serialized.TypeTranslator;
...
/**
 * In weibei, amounts are either XRP, the native currency, or an IOU of
...
//    public static final Amount NEUTRAL_ZERO = new Amount(Currency.NEUTRAL, AccountID.NEUTRAL);
    ...
    Divide and multiply are equivalent to the javascript weibei-lib
    ...
    */
    ...
    public static class Translator extends TypeTranslator<Amount> {
        ...
        public Amount fromString(String s) {
            ...
            return com.weibei.core.coretypes.Amount.fromString(s);
        }
    ...
    /**
     * @return A String representation as used by weibei json format
     */
    ...
    static public AmountField WeibeiEscrow = amountField(Field.WeibeiEscrow);
