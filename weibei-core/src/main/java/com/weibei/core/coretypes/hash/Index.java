package com.weibei.core.coretypes.hash;
...
import com.weibei.core.coretypes.hash.prefixes.LedgerSpace;
...
import static com.weibei.core.coretypes.hash.HalfSha512.prefixed256;
...
public class Index {
    ...
    public static Hash256 weibeiState(AccountID a1, AccountID a2, Currency currency) {
        List<AccountID> accounts = Arrays.asList(a1, a2);
        sort(accounts);
        return weibeiState(accounts, currency);
    }

    public static Hash256 weibeiState(List<AccountID> accounts, Currency currency) {
        HalfSha512 hasher = prefixed256(LedgerSpace.weibei);
        // Low then High
