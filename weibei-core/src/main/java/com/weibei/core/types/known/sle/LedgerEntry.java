package com.weibei.core.types.known.sle;
...
//    public void ledgerEntryType(LedgerEntryType val) {put(Field.LedgerEntryType, val);}
    ...
    public static abstract class OnLedgerEntry {
        ...
        public abstract void onWeibeiState(WeibeiState rs);
        ...
        public void onObject(STObject object) {
            ...
            } else if (object instanceof WeibeiState) {
                onWeibeiState((WeibeiState) object);
            }
