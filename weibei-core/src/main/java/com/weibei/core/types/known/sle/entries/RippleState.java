package com.weibei.core.types.known.sle.entries;
...
import com.weibei.core.coretypes.Issue;
...
import com.weibei.core.enums.LedgerFlag;
import com.weibei.core.fields.AmountField;
import com.weibei.core.fields.Field;
import com.weibei.core.serialized.enums.LedgerEntryType;
import com.weibei.core.types.known.sle.ThreadedLedgerEntry;

import java.util.Arrays;
import java.util.List;

public class WeibeiState extends ThreadedLedgerEntry {
    /**
    The WeibeiState is a ledger entry which roughly speaking defines the balance and
    ...
    Thus, the one Balance in a weibei state actually implies 4 distinct balances.
    ...
    * */
    ...
    public WeibeiState() {
        super(LedgerEntryType.WeibeiState);
    }
