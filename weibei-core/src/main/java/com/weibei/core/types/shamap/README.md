...
public class NodeStore {
    /**
    * In weibei, all data is stored in a simple binary key/value database.
    ...
    */
     ...
     * Weibei uses the first 256 bits of a sha512 as it's 33 percent
    ...
    /**
     * @param hash As weibei uses the `hash` of the contents as the
...
* [BinaryFormats.txt (historical)](https://github.com/weibei/weibeid/blob/07df5f1f81b0ee1ab641d134ba8e940a90f5297e/BinaryFormats.txt#L2-L6)
...
The identifier is used as an `index` into a ShaMap tree, which in weibei, is
...
* [ShamapInnerNodeAnalyis](../../../../../../../../../weibei-examples/weibei-cli/src/main/java/com/weibei/cli/shamapanalysis/ShamapInnerNodeAnalysis.java)
* [Weibeid Hash Prefix declarations](https://github.com/weibei/weibei-lib-java/blob/master/weibei-core/src/main/java/com/weibei/core/coretypes/hash/prefixes/HashPrefix.java)
