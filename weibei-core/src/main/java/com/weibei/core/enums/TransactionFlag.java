...
public class TransactionFlag {
    ...
    // Payment flags:
    NoWeibeiDirect = 0x00010000,
    PartialPayment = 0x00020000,
    LimitQuality = 0x00040000,
    PaymentMask = ~(Universal | PartialPayment | LimitQuality | NoWeibeiDirect),

    // TrustSet flags:
    SetAuth = 0x00010000,
    SetNoWeibei = 0x00020000,
    ClearNoWeibei = 0x00040000,
    SetFreeze            = 0x00100000,
    ClearFreeze          = 0x00200000,
    TrustSetMask = ~(Universal | SetAuth | SetNoWeibei | ClearNoWeibei | SetFreeze | ClearFreeze);
}
