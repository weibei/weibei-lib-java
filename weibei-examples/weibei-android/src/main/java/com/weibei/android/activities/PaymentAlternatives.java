...
import com.weibei.android.JSON;
import com.weibei.android.Logger;
import com.weibei.android.R;
import com.weibei.android.WeibeiApplication;
...
import com.weibei.client.payments.Alternative;
import com.weibei.client.payments.Alternatives;
import com.weibei.client.payments.PaymentFlow;
import com.weibei.client.pubsub.CallbackContext;
import com.weibei.client.requests.Request;
import com.weibei.client.responses.Response;
import com.weibei.client.subscriptions.TrackedAccountRoot;
...
import static com.weibei.client.Client.log;
...
public class PaymentAlternatives extends Activity {
    ...
    BlobVault blobVault = new BlobVault("https://blobvault.weibei.com/");
    ...
    private void setupClient() {
        client = ((WeibeiApplication) getApplication()).getClient();
