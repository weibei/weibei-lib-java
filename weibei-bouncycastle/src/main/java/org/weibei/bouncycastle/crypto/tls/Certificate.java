 ...
 * </pre>
 *
 * @see org.weibei.bouncycastle.asn1.x509.Certificate
 */
public class Certificate
{

    public static final Certificate EMPTY_CHAIN = new Certificate(
        new org.weibei.bouncycastle.asn1.x509.Certificate[0]);

    protected org.weibei.bouncycastle.asn1.x509.Certificate[] certificateList;

    public Certificate(org.weibei.bouncycastle.asn1.x509.Certificate[] certificateList)
    {
     ...
     */
    public org.weibei.bouncycastle.asn1.x509.Certificate[] getCerts()
    {
        return clone(certificateList);
    }

    /**
     * @return an array of {@link org.weibei.bouncycastle.asn1.x509.Certificate} representing a certificate
     *         chain.
     */
    public org.weibei.bouncycastle.asn1.x509.Certificate[] getCertificateList()
    {
        return clone(certificateList);
    }

    public org.weibei.bouncycastle.asn1.x509.Certificate getCertificateAt(int index)
    {
    ...
    public static Certificate parse(InputStream input)
        throws IOException
    {
        org.weibei.bouncycastle.asn1.x509.Certificate[] certs;
        ...
        while (left > 0)
        {
            ...
            tmp.addElement(org.weibei.bouncycastle.asn1.x509.Certificate.getInstance(asn1));
        }
        certs = new org.weibei.bouncycastle.asn1.x509.Certificate[tmp.size()];
        for (int i = 0; i < tmp.size(); i++)
        {
            certs[i] = (org.weibei.bouncycastle.asn1.x509.Certificate)tmp.elementAt(i);
        }
        return new Certificate(certs);
    }

    private org.weibei.bouncycastle.asn1.x509.Certificate[] clone(org.weibei.bouncycastle.asn1.x509.Certificate[] list)
    {
        org.weibei.bouncycastle.asn1.x509.Certificate[] rv = new org.weibei.bouncycastle.asn1.x509.Certificate[list.length];
