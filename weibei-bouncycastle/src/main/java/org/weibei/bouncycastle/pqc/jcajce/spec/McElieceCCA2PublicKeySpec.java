 ...
 *
 * @see org.weibei.bouncycastle.pqc.jcajce.provider.mceliece.BCMcElieceCCA2PublicKey
 */
    ...
    implements KeySpec
{
    ...
    /**
     * Constructor (used by {@link org.weibei.bouncycastle.pqc.jcajce.provider.mceliece.McElieceKeyFactorySpi}).
     *
     * @param n         length of the code
