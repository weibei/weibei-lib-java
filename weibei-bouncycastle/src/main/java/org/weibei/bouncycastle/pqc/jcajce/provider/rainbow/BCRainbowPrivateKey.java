package org.weibei.bouncycastle.pqc.jcajce.provider.rainbow;
...
import org.weibei.bouncycastle.pqc.asn1.RainbowPrivateKey;
import org.weibei.bouncycastle.pqc.crypto.rainbow.Layer;
import org.weibei.bouncycastle.pqc.crypto.rainbow.RainbowPrivateKeyParameters;
import org.weibei.bouncycastle.pqc.crypto.rainbow.util.RainbowUtil;
import org.weibei.bouncycastle.pqc.jcajce.spec.RainbowPrivateKeySpec;
    ...
    implements PrivateKey
{
    ...
    public int hashCode()
    {
        ...
        hash = hash * 37 + org.weibei.bouncycastle.util.Arrays.hashCode(A1inv);
        hash = hash * 37 + org.weibei.bouncycastle.util.Arrays.hashCode(b1);
        hash = hash * 37 + org.weibei.bouncycastle.util.Arrays.hashCode(A2inv);
        hash = hash * 37 + org.weibei.bouncycastle.util.Arrays.hashCode(b2);
        hash = hash * 37 + org.weibei.bouncycastle.util.Arrays.hashCode(vi);
