 ...
 * {@link org.weibei.bouncycastle.x509.X509Store} SPI implementation for certificate
 * pairs.
 *
 * @see org.weibei.bouncycastle.x509.X509Store
 * @see org.weibei.bouncycastle.x509.X509CertificatePair
 */
public class X509StoreCertPairCollection extends X509StoreSpi
{
     ...
     * {@link org.weibei.bouncycastle.x509.X509CertificatePair}s. The selector must be
     * a {@link org.weibei.bouncycastle.x509.X509CertPairStoreSelector} to select
     * certificate pairs.
     *
