package org.weibei.bouncycastle.jcajce.provider.keystore.pkcs12;
...
import org.weibei.bouncycastle.asn1.ASN1Set;
import org.weibei.bouncycastle.asn1.BEROctetString;
import org.weibei.bouncycastle.asn1.BEROutputStream;
import org.weibei.bouncycastle.asn1.DERBMPString;
import org.weibei.bouncycastle.asn1.DERNull;
import org.weibei.bouncycastle.asn1.DEROctetString;
import org.weibei.bouncycastle.asn1.DEROutputStream;
import org.weibei.bouncycastle.asn1.DERSequence;
import org.weibei.bouncycastle.asn1.DERSet;
import org.weibei.bouncycastle.asn1.pkcs.AuthenticatedSafe;
import org.weibei.bouncycastle.asn1.pkcs.CertBag;
import org.weibei.bouncycastle.asn1.pkcs.ContentInfo;
import org.weibei.bouncycastle.asn1.pkcs.EncryptedData;
import org.weibei.bouncycastle.asn1.pkcs.MacData;
import org.weibei.bouncycastle.asn1.pkcs.PBES2Parameters;
import org.weibei.bouncycastle.asn1.pkcs.PBKDF2Params;
import org.weibei.bouncycastle.asn1.pkcs.PKCS12PBEParams;
import org.weibei.bouncycastle.asn1.pkcs.PKCSObjectIdentifiers;
import org.weibei.bouncycastle.asn1.pkcs.Pfx;
import org.weibei.bouncycastle.asn1.pkcs.SafeBag;
import org.weibei.bouncycastle.asn1.util.ASN1Dump;
...
import org.weibei.bouncycastle.asn1.x509.DigestInfo;
import org.weibei.bouncycastle.asn1.x509.Extension;
import org.weibei.bouncycastle.asn1.x509.SubjectKeyIdentifier;
...
import org.weibei.bouncycastle.jcajce.provider.config.PKCS12StoreParameter;
import org.weibei.bouncycastle.jcajce.provider.symmetric.util.BCPBEKey;
import org.weibei.bouncycastle.jcajce.provider.util.SecretKeyUtil;
import org.weibei.bouncycastle.jce.interfaces.BCKeyStore;
import org.weibei.bouncycastle.jce.interfaces.PKCS12BagAttributeCarrier;
import org.weibei.bouncycastle.jce.provider.BouncyCastleProvider;
import org.weibei.bouncycastle.jce.provider.JDKPKCS12StoreParameter;
import org.weibei.bouncycastle.util.Arrays;
import org.weibei.bouncycastle.util.Strings;
    ...
    implements PKCSObjectIdentifiers, X509ObjectIdentifiers, BCKeyStore
{
            ...
            for (int i = 0; i != c.length; i++)
            {
                if (c[i].getContentType().equals(data))
                {
                    ...
                    for (int j = 0; j != seq.size(); j++)
                    {
                        ...
                        {
                            org.weibei.bouncycastle.asn1.pkcs.EncryptedPrivateKeyInfo eIn = org.weibei.bouncycastle.asn1.pkcs.EncryptedPrivateKeyInfo.getInstance(b.getBagValue());
                ...
                else if (c[i].getContentType().equals(encryptedData))
                {
                    ...
                    for (int j = 0; j != seq.size(); j++)
                    {
                        ...
                        {
                            org.weibei.bouncycastle.asn1.pkcs.PrivateKeyInfo kInfo = org.weibei.bouncycastle.asn1.pkcs.PrivateKeyInfo.getInstance(b.getBagValue());
        ...
        throws IOException
    {
        ...
        while (ks.hasMoreElements())
        {
            ...
            org.weibei.bouncycastle.asn1.pkcs.EncryptedPrivateKeyInfo kInfo = new org.weibei.bouncycastle.asn1.pkcs.EncryptedPrivateKeyInfo(kAlgId, kBytes);
