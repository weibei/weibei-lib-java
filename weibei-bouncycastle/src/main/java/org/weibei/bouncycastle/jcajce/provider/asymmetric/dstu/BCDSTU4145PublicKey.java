package org.weibei.bouncycastle.jcajce.provider.asymmetric.dstu;
...
import org.weibei.bouncycastle.asn1.DERBitString;
import org.weibei.bouncycastle.asn1.DERNull;
import org.weibei.bouncycastle.asn1.DEROctetString;
import org.weibei.bouncycastle.asn1.ua.DSTU4145BinaryField;
import org.weibei.bouncycastle.asn1.ua.DSTU4145ECBinary;
import org.weibei.bouncycastle.asn1.ua.DSTU4145NamedCurves;
import org.weibei.bouncycastle.asn1.ua.DSTU4145Params;
import org.weibei.bouncycastle.asn1.ua.DSTU4145PointEncoder;
import org.weibei.bouncycastle.asn1.ua.UAObjectIdentifiers;
...
import org.weibei.bouncycastle.asn1.x9.X962Parameters;
import org.weibei.bouncycastle.asn1.x9.X9ECParameters;
import org.weibei.bouncycastle.asn1.x9.X9ECPoint;
import org.weibei.bouncycastle.asn1.x9.X9IntegerConverter;
...
import org.weibei.bouncycastle.jcajce.provider.asymmetric.util.EC5Util;
import org.weibei.bouncycastle.jcajce.provider.asymmetric.util.ECUtil;
import org.weibei.bouncycastle.jcajce.provider.asymmetric.util.KeyUtil;
import org.weibei.bouncycastle.jce.interfaces.ECPointEncoder;
import org.weibei.bouncycastle.jce.provider.BouncyCastleProvider;
import org.weibei.bouncycastle.jce.spec.ECNamedCurveParameterSpec;
import org.weibei.bouncycastle.jce.spec.ECNamedCurveSpec;
import org.weibei.bouncycastle.math.ec.ECCurve;

public class BCDSTU4145PublicKey
    implements ECPublicKey, org.weibei.bouncycastle.jce.interfaces.ECPublicKey, ECPointEncoder
{
    ...
    private transient org.weibei.bouncycastle.math.ec.ECPoint q;
    ...
    public BCDSTU4145PublicKey(
        org.weibei.bouncycastle.jce.spec.ECPublicKeySpec spec)
    {
        this.q = spec.getQ();
        ...
        else
        {
            if (q.getCurve() == null)
            {
                org.weibei.bouncycastle.jce.spec.ECParameterSpec s = BouncyCastleProvider.CONFIGURATION.getEcImplicitlyCa();
    ...
    public BCDSTU4145PublicKey(
        String algorithm,
        ECPublicKeyParameters params,
        org.weibei.bouncycastle.jce.spec.ECParameterSpec spec)
    {
        ECDomainParameters dp = params.getParameters();
    ...
    private void populateFromPubKeyInfo(SubjectPublicKeyInfo info)
    {
        if (info.getAlgorithm().getAlgorithm().equals(UAObjectIdentifiers.dstu4145be) || info.getAlgorithm().getAlgorithm().equals(UAObjectIdentifiers.dstu4145le))
        {
            ...
            org.weibei.bouncycastle.jce.spec.ECParameterSpec spec = null;
            ...
            else
            {
                ...
                spec = new org.weibei.bouncycastle.jce.spec.ECParameterSpec(curve, DSTU4145PointEncoder.decodePoint(curve, g_bytes), binary.getN());
            }
    ...
    public org.weibei.bouncycastle.jce.spec.ECParameterSpec getParameters()
    {
    ...
    public org.weibei.bouncycastle.math.ec.ECPoint getQ()
    {
        if (ecSpec == null)
        {
            if (q instanceof org.weibei.bouncycastle.math.ec.ECPoint.Fp)
            {
                return new org.weibei.bouncycastle.math.ec.ECPoint.Fp(null, q.getX(), q.getY());
            }
            else
            {
                return new org.weibei.bouncycastle.math.ec.ECPoint.F2m(null, q.getX(), q.getY());
            }
        }
    ...
    public org.weibei.bouncycastle.math.ec.ECPoint engineGetQ()
    {
        return q;
    }

    org.weibei.bouncycastle.jce.spec.ECParameterSpec engineGetSpec()
    {
        if (ecSpec != null)
        {
            return EC5Util.convertSpec(ecSpec, withCompression);
