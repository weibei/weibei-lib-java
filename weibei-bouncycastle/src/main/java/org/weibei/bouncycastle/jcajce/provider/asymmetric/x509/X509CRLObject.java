...
import org.weibei.bouncycastle.asn1.x509.CRLNumber;
import org.weibei.bouncycastle.asn1.x509.CertificateList;
...
import org.weibei.bouncycastle.asn1.x509.TBSCertList;
            ...
            for (int i = 0; i < certs.length; i++)
            {
                ...
                if (certs[i].getUserCertificate().getValue().equals(serial))
                {
                    ...
                    else
                    {
                        try
                        {
                            issuer = org.weibei.bouncycastle.asn1.x509.Certificate.getInstance(cert.getEncoded()).getIssuer();
                        }
