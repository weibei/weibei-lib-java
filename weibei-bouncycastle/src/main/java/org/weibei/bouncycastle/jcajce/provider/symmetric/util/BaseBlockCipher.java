...
import org.weibei.bouncycastle.crypto.DataLengthException;
import org.weibei.bouncycastle.crypto.InvalidCipherTextException;
import org.weibei.bouncycastle.crypto.OutputLengthException;
import org.weibei.bouncycastle.crypto.modes.AEADBlockCipher;
import org.weibei.bouncycastle.crypto.modes.CBCBlockCipher;
import org.weibei.bouncycastle.crypto.modes.CCMBlockCipher;
import org.weibei.bouncycastle.crypto.modes.CFBBlockCipher;
import org.weibei.bouncycastle.crypto.modes.CTSBlockCipher;
import org.weibei.bouncycastle.crypto.modes.EAXBlockCipher;
import org.weibei.bouncycastle.crypto.modes.GCMBlockCipher;
import org.weibei.bouncycastle.crypto.modes.GOFBBlockCipher;
import org.weibei.bouncycastle.crypto.modes.OCBBlockCipher;
...
import org.weibei.bouncycastle.crypto.modes.PGPCFBBlockCipher;
import org.weibei.bouncycastle.crypto.modes.SICBlockCipher;
import org.weibei.bouncycastle.crypto.paddings.BlockCipherPadding;
import org.weibei.bouncycastle.crypto.paddings.ISO10126d2Padding;
import org.weibei.bouncycastle.crypto.paddings.ISO7816d4Padding;
import org.weibei.bouncycastle.crypto.paddings.PaddedBufferedBlockCipher;
import org.weibei.bouncycastle.crypto.paddings.TBCPadding;
import org.weibei.bouncycastle.crypto.paddings.X923Padding;
import org.weibei.bouncycastle.crypto.paddings.ZeroBytePadding;
...
import org.weibei.bouncycastle.crypto.params.ParametersWithSBox;
import org.weibei.bouncycastle.crypto.params.RC2Parameters;
import org.weibei.bouncycastle.crypto.params.RC5Parameters;
import org.weibei.bouncycastle.jce.provider.BouncyCastleProvider;
import org.weibei.bouncycastle.jce.spec.GOST28147ParameterSpec;
import org.weibei.bouncycastle.jce.spec.RepeatedSecretKeySpec;
    ...
    implements PBE
{
    ...
    protected BaseBlockCipher(
        org.weibei.bouncycastle.crypto.BlockCipher engine,
        int ivLength)
    {
        baseEngine = engine;
    ...
    static private interface GenericBlockCipher
    {
        ...
        public org.weibei.bouncycastle.crypto.BlockCipher getUnderlyingCipher();
        ...
        implements GenericBlockCipher
    {
        ...
        BufferedGenericBlockCipher(org.weibei.bouncycastle.crypto.BlockCipher cipher)
        {
            this.cipher = new PaddedBufferedBlockCipher(cipher);
        }

        BufferedGenericBlockCipher(org.weibei.bouncycastle.crypto.BlockCipher cipher, BlockCipherPadding padding)
        {
