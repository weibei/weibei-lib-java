...
public class EC5Util
{
    ...
    public static org.weibei.bouncycastle.jce.spec.ECParameterSpec convertSpec(
        ECParameterSpec ecSpec,
        boolean withCompression)
    {
        ECCurve curve = convertCurve(ecSpec.getCurve());

        return new org.weibei.bouncycastle.jce.spec.ECParameterSpec(
            curve,
    ...
    public static org.weibei.bouncycastle.math.ec.ECPoint convertPoint(
        ECParameterSpec ecSpec,
        ECPoint point,
        boolean withCompression)
    {
