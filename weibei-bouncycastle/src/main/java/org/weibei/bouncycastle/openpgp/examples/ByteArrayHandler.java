...
import org.weibei.bouncycastle.bcpg.CompressionAlgorithmTags;
...
import org.weibei.bouncycastle.openpgp.PGPEncryptedDataGenerator;
import org.weibei.bouncycastle.openpgp.PGPEncryptedDataList;
...
import org.weibei.bouncycastle.openpgp.PGPPBEEncryptedData;
...
import org.weibei.bouncycastle.openpgp.operator.jcajce.JcePBEDataDecryptorFactoryBuilder;
...
public class ByteArrayHandler
{
    ...
    public static void main(String[] args) throws Exception
    {
        ...
        System.out.println("\nencrypted data = '"+new String(org.weibei.bouncycastle.util.encoders.Hex.encode(encrypted))+"'");
